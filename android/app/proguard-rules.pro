...
# ── #3 R8: extra defensive keeps for shrinking (Play Console) ──
# Facebook SDK (facebook-android-sdk) — uses reflection internally.
-keep class com.facebook.** { *; }
-dontwarn com.facebook.**

# Barcode scanner (qr_code_scanner_plus → journeyapps / zxing).
-keep class com.journeyapps.barcodescanner.** { *; }
-keep class com.google.zxing.** { *; }
-dontwarn com.google.zxing.**

# Play Integrity (SafetyNet replacement) used by Firebase Auth.
-keep class com.google.android.play.core.integrity.** { *; }
-dontwarn com.google.android.play.core.integrity.**

# Keep Flutter deferred-components / embedding entry points.
