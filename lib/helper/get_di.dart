...
import 'package:sixam_mart/features/support/domain/services/support_service.dart';
...
// ====================================
  ...
  final SupportRepositoryInterface supportRepositoryInterface =
      SupportRepository(apiClient: Get.find());
  ...
  // âڑ، FIX: Register CampaignServiceInterface with fenix: true
  ...
  final SupportServiceInterface supportServiceInterface =
      SupportService(supportRepositoryInterface: Get.find());
  ...
  // âڑ، SINGLETON FIX: CategoryController must be permanent singleton to prevent multiple instances
  ...
  Get.lazyPut(() => SupportController(supportServiceInterface: Get.find()));
  ...
  // âڑ، Cache-First Fix: Register CampaignController with fenix: true
