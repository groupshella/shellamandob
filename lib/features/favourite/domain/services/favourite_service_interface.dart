...
abstract class FavouriteServiceInterface {
  ...
  Future<ResponseModel> addFavouriteList(int? id, bool isStore, {bool isOrder = false});
  Future<ResponseModel> removeFavouriteList(int? id, bool isStore, {bool isOrder = false});
