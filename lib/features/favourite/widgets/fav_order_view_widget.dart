  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<FavouriteController>(builder: (favouriteController) {
        final List<OrderModel>? orders = favouriteController.wishOrderList;
        final bool isLoading = orders == null;
                  ...
                  if (order.id != null)
                    GetBuilder<FavouriteController>(
                      builder: (favouriteController) {
                        final isWished = favouriteController.wishOrderIdList.contains(order.id!);
                        return InkWell(
                          onTap: () => favouriteController.toggleFavouriteOrder(order.id!, order: order),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: isWished ? primary.withValues(alpha: 0.12) : Theme.of(context).disabledColor.withValues(alpha: 0.12),
                            ),
                            child: Icon(
                              isWished ? Icons.favorite : Icons.favorite_border,
                              size: 18,
                              color: isWished ? primary : Theme.of(context).disabledColor,
                            ),
                          ),
                        );
                      },
