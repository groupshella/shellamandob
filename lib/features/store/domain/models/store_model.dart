...
class Store {
  ...
  bool? shellaWallet;
  bool? hasStoreContract;
  double? qidhaCreditLimit;
  double? qidhaAvailableBalance;
  double? qidhaUsedBalance;
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    if (json['delivery'] is Map) {
      delivery = json['delivery']['delivery_available'] == true ||
          json['delivery']['delivery_available'] == 1 ||
          json['delivery']['delivery_available'] == '1' ||
          json['delivery']['delivery_available'] == 'true';
    } else {
    ...
    final Map? storeConfig =
        json['store_config'] is Map ? json['store_config'] as Map : null;
    final Map? paymentMethods = json['payment_methods'] is Map
        ? json['payment_methods'] as Map
        : null;
    final bool rawShella = json.parseBool('shella_wallet') ||
        json.parseBool('is_qidha') ||
        json.parseBool('qaydha_credit');
    final bool pmShella = paymentMethods != null &&
        (paymentMethods['shella_wallet'] == true ||
            paymentMethods['shella_wallet'].toString() == '1' ||
            paymentMethods['shella_wallet'].toString() == 'true' ||
            paymentMethods['qaydha_credit'] == true ||
            paymentMethods['qaydha_credit'].toString() == '1' ||
            paymentMethods['qaydha_credit'].toString() == 'true' ||
            paymentMethods['is_qidha'] == true ||
            paymentMethods['is_qidha'].toString() == '1' ||
            paymentMethods['is_qidha'].toString() == 'true');
    final bool scShella = storeConfig != null &&
        (storeConfig['shella_wallet'] == true ||
            storeConfig['shella_wallet'].toString() == '1' ||
            storeConfig['shella_wallet'].toString() == 'true' ||
            storeConfig['qaydha_credit'] == true ||
            storeConfig['qaydha_credit'].toString() == '1' ||
            storeConfig['qaydha_credit'].toString() == 'true' ||
            storeConfig['is_qidha'] == true ||
            storeConfig['is_qidha'].toString() == '1' ||
            storeConfig['is_qidha'].toString() == 'true');
    shellaWallet = rawShella || pmShella || scShella;
    hasStoreContract = json.parseBool('has_store_contract') || json.containsKey('qidha_credit_limit');
    qidhaCreditLimit = json.parseDouble('qidha_credit_limit') ?? json.parseDouble('contract_amount');
    qidhaAvailableBalance = json.parseDouble('qidha_available_balance') ?? json.parseDouble('remaining_balance') ?? qidhaCreditLimit;
    qidhaUsedBalance = json.parseDouble('qidha_used_balance') ?? json.parseDouble('used_balance');
    if (hasStoreContract == true || qidhaCreditLimit != null) {
      shellaWallet = true;
    }
    debugPrint(
        '🏪 [Store.fromJson] id=$id name=$name shellaWallet=$shellaWallet qidhaLimit=$qidhaCreditLimit qidhaAvail=$qidhaAvailableBalance');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['shella_wallet'] = shellaWallet;
    data['active'] = active;
    data['veg'] = veg;
    ...
    data['has_store_contract'] = hasStoreContract;
    data['qidha_credit_limit'] = qidhaCreditLimit;
    data['qidha_available_balance'] = qidhaAvailableBalance;
    data['qidha_used_balance'] = qidhaUsedBalance;
