...
class SignUpWidgetState extends State<SignUpWidget> {
  ...
  void initState() {
    ...
    if (Get.isRegistered<SharedPreferences>()) {
      final storedToken = QrReferralTokenStorage(Get.find<SharedPreferences>()).getStoredToken();
      if (storedToken != null && storedToken.isNotEmpty) {
        _referCodeController.text = storedToken;
      }
    }
  }
    ...
    if (_formKeySignUp!.currentState!.validate()) {
      if (name.isEmpty) {
        ...
        final SignUpBodyModel signUpBody = SignUpBodyModel(
          ...
          password: password,
          refCode: referCode.isNotEmpty ? referCode : null,
        );
        return signUpBody;
      }
    }
