...
class _HomeCurrentOffersSectionState extends State<HomeCurrentOffersSection> {
  ...
  void _startAutoScroll() {
    ...
    _autoScrollTimer = Timer.periodic(const Duration(seconds: 10), (_) {
      ...
      const double step = HomeCurrentOffersSection._cardWidth + 8;
      double target =
...
class _OfferCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        width: HomeCurrentOffersSection._cardWidth + 25,
        decoration: BoxDecoration(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            if ((offer.offerTitle?.trim().isNotEmpty ??
                                    false) &&
                                (offer.storeName?.trim().isNotEmpty ?? false))
                              Padding(
                                padding:
                                    const EdgeInsets.only(right: 50, top: 1),
                                child: Text(
    ...
    AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          child:
              Text('cancel'.tr, style: const TextStyle(fontFamily: 'Tajawal')),
        ),
        TextButton(
