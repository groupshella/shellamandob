...
/// Adds one unit of the offer's item to the online cart.
Future<void> _addOfferToCart(OfferItem offer) async {
  ...
  // Ensure guest session if user is not logged in and has no guest ID
  ...
  try {
    ...
    if (!ok) {
      ...
      showCustomSnackBar('product_added_successfully'.tr, isError: false);
    }
  } catch (e) {
                              ...
                              children: [
                                ...
                                GetBuilder<FavouriteController>(
                                  builder: (fav) {
                                    if (Get.isRegistered<
                                            FavouriteController>() &&
                                        fav.wishItemList == null) {
                                      WidgetsBinding.instance
                                          .addPostFrameCallback((_) {
                                        fav.getFavouriteList();
                                      });
                                    }
                                    final bool isWished =
                                        offer.itemId != null &&
                                      ...
                                      onTap: () {
                                        ...
                                        if (isWished) {
                                          ...
                                          final item = Item(
                                            ...
                                            imageFullUrl: offer.imageUrl,
                                            storeId: offer.storeId,
                                            moduleId: offer.moduleId,
                                          );
                                          fav.addToFavouriteList(
                                              item, null, false);
                                        }
                                      },
                                    );
                            ...
                            if (hasPrice) ...[
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Spacer(),
                                  if (hasOldPrice) ...[
                                    _sheetPrice(offer.originalPrice,
                                        struck: true),
