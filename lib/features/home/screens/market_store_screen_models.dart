...
class _Product {
  ...
  /// How many times the item has been ordered (e.g. "ط¹ط¯ط¯ ط§ظ„ط·ظ„ط¨ط§طھ: +500").
  ...
  /// Discount percentage (e.g. 6 â†’ "-6%"); 0 when there is no discount.
...
/// "طھظ…طھ ط¥ط¶ط§ظپط© ط§ظ„ظ…ظ†طھط¬ ط¨ظ†ط¬ط§ط­" toast shown after a successful add-to-cart. A light
...
class _FeaturedSection {
  ...
  factory _FeaturedSection.fromJson(Map<String, dynamic> j) => _FeaturedSection(
        ...
        // `cover_photo_full_url`; older keys kept as fallbacks. Empty â†’ the
...
class _StoreDetail {
  ...
  factory _StoreDetail.fromJson(Map<String, dynamic> j) {
    ...
    return _StoreDetail(
      ...
      rating: _Product._d(j['rating'] ?? j['avg_rating']),
