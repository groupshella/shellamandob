...
import 'package:sixam_mart/features/home/widgets/home_qidha_promo_banner.dart';
import 'package:sixam_mart/features/home/widgets/home_first_order_gift_banner.dart';
                        ...
                        child: ResponsiveHelper.isDesktop(context)
                            ...
                            : CustomScrollView(
                                ...
                                slivers: [
                                  ...
                                  // 🎁 First-Order Gift & In-Store Partner Banner
                                  const SliverToBoxAdapter(
                                    child: HomeFirstOrderGiftBanner(),
                                  ),

                                  // Qidha Promo Banner
                                  const SliverToBoxAdapter(
                                    child: HomeQidhaPromoBanner(),
                                  ),
...
class _OldOffersSectionState extends State<_OldOffersSection> {
  ...
  Future<void> _load() async {
    ...
    if (controller.offersMode?.data.isNotEmpty ?? false) {
