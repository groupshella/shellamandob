...
class OrderModel {
  ...
  int? isDmReviewed;
  int? isStoreReviewed;
  int? storeReviewRating;
  String? storeReviewComment;
  int? dmReviewRating;
  String? dmReviewComment;
  ...
  OrderModel({
    ...
    this.isReviewed,
    this.isDmReviewed,
    this.isStoreReviewed,
    this.storeReviewRating,
    this.storeReviewComment,
    this.dmReviewRating,
    this.dmReviewComment,
  });

  OrderModel.fromJson(Map<String, dynamic> json) {
    id = json.parseInt('id');
    userId = json.parseInt('user_id');
    isReviewed = json.parseInt('is_reviewed');
    isDmReviewed = json.parseInt('is_dm_reviewed');
    isStoreReviewed = json.parseInt('is_store_reviewed');
    storeReviewRating = json.parseInt('store_review_rating');
    storeReviewComment = json.parseString('store_review_comment');
    dmReviewRating = json.parseInt('dm_review_rating');
    dmReviewComment = json.parseString('dm_review_comment');
