    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            GetBuilder<OrderController>(builder: (orderController) {
              ...
              return IconButton(
                icon: const Icon(Icons.receipt_long, color: Color(0xFF121C19)),
                onPressed: () {
                  Get.bottomSheet(
                    InvoiceBottomSheet(
                      order: track,
        ...
        body: SafeArea(
          ...
          // Prefer the ACTUAL total tax the backend returned on the order object.
          // If missing, fall back to the sum of per-line taxes (taxFromDetails).
          // If that's also missing, compute it as a fallback.
