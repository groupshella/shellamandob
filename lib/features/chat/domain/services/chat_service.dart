...
class ChatService implements ChatServiceInterface {
  ...
  Future<StoreModel?> searchStoreList(String name) async {
    return await chatRepositoryInterface.searchStoreList(name);
  }
  ...
  Future<bool> archiveConversation(int conversationId) async {
    return await chatRepositoryInterface.archiveConversation(conversationId);
  }
  ...
  List<String> getChatSearchHistory() {
    return chatRepositoryInterface.getChatSearchHistory();
  }

  @override
  void saveChatSearchHistory(List<String> searchHistory) {
    chatRepositoryInterface.saveChatSearchHistory(searchHistory);
  }

  @override
  void clearChatSearchHistory() {
    chatRepositoryInterface.clearChatSearchHistory();
  }
