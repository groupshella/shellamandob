...
class Conversation {
  ...
  String? status;
  String? closedAt;
  int? isArchivedBySender;
  int? isArchivedByReceiver;
  ...
  Conversation.fromJson(Map<String, dynamic> json) {
    ...
    status = json.parseString('status') ?? 'open';
    closedAt = json['closed_at']?.toString();
    isArchivedBySender = json.parseInt('is_archived_by_sender');
    isArchivedByReceiver = json.parseInt('is_archived_by_receiver');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_archived_by_sender'] = isArchivedBySender;
    data['is_archived_by_receiver'] = isArchivedByReceiver;
    if (sender != null) {
