                      ...
                      children: [
                        ...
                        && widget.chatController.conversationModel!.conversations!.isNotEmpty) ? Padding(
                          ...
                          child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: WebSearchField(
                            prefixWidget: widget.chatController.searchStoreModel != null ? null: Padding(
                            ...
                            hint: 'search_'.tr,
                            suffixIcon: widget.chatController.searchStoreModel != null ? Icons.close : null,
                            ...
                            iconPressed: () {
                              if(widget.chatController.searchStoreModel != null) {
