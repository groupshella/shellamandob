...
class ReviewService implements ReviewServiceInterface {
  ...
  Future<ResponseModel> submitReview(ReviewBodyModel reviewBody) async {
    ...
    return result is ResponseModel
        ? result
        : ResponseModel(false, 'Error submitting review');
  }
  ...
  Future<ResponseModel> submitDeliveryManReview(
    ...
    final result =
        await reviewRepositoryInterface.submitDeliveryManReview(reviewBody);
    return result is ResponseModel
        ? result
        : ResponseModel(false, 'Error submitting delivery man review');
  }

  @override
  Future<ResponseModel> submitStoreReview(ReviewBodyModel reviewBody) async {
    final result =
        await reviewRepositoryInterface.submitStoreReview(reviewBody);
    return result is ResponseModel
        ? result
        : ResponseModel(false, 'Error submitting store review');
  }
}