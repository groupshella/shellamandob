...
class _Befor_Pdf_ScreenState extends State<Befor_Pdf_Screen> {
  ...
  final List<_ContractClause> _clauses = [
    ...
    _ContractClause(
      number: '4',
      title: 'data_processing_privacy'.tr,
      content:
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomButton(
                    buttonText: 'agree_and_continue'.tr,
                    color: _allChecked
