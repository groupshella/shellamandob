...
import 'package:sixam_mart/features/wallet_kaidha_subscription/widget/qidha_success_dialog.dart';
...
class _WalletKaidhaScreenState extends State<WalletKaidhaScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      bool successShown = prefs.getBool('qidha_success_shown') ?? false;
      if (!successShown) {
        await prefs.setBool('qidha_success_shown', true);
        Get.dialog(const QidhaSuccessDialog(), barrierDismissible: false);
      }
    });
                    ...
                    : wallet == null
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              // ── 1. Top Banner: المتاجر المتعاقد معها (Already contracted) ──
                              Container(
                                decoration: BoxDecoration(
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'تصفح المتاجر والمطاعم المعتمدة للشراء بقيدها',
                                                  style: TextStyle(
                                                    fontFamily: 'Tajawal',
                                                    fontSize: 12,
                              ...
                              // ── 2. Bottom Banner: المتاجر المتاحة للتعاقد (Available for contract) ──
                              Container(
                                decoration: BoxDecoration(
                                  gradient: const LinearGradient(
                                    colors: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(height: 3),
                                                Text(
                                                  'استكشف المتاجر واطلب إضافة متجرك المفضل بقيدها',
                                                  style: TextStyle(
                                                    fontFamily: 'Tajawal',
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w500,
