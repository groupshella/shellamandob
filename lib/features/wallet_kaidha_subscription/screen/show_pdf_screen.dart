...
class _ShowPdfScreenState extends State<ShowPdfScreen> {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        // Progress steps (RTL 4-step timeline: received → reviewing → promissory note → activated).
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _step(Icons.check_circle_outline, 'تم استلام الطلب',
                                done: true),
                            _line(true),
                            _step(Icons.access_time_rounded, 'قيد المراجعة',
                                active: true),
                            _line(false),
                            _step(Icons.description_outlined, 'توثيق السند'),
                            _line(false),
                            _step(Icons.credit_card_outlined, 'تفعيل المحفظة'),
                          ],
                        ),
  ...
  // `active` = current (green ring + background), otherwise upcoming (grey).
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon,
                size: 18, color: done ? Colors.white : color),
          ),
