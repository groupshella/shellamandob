...
abstract class KaidhaSubRepositoryInterface {
  ...
  Future<NafathCheckStatusModel?> Nafath_send_checkStatus(BuildContext context, String nationalId, {bool confirmed = false});
  ...
  Future<List<int>> getRequestedStoreIds();

  Future<List<Store>?> getQidhaContractedStores({int? moduleId, String? type, String? search, int? offset, int? limit});

  Future<List<Store>?> getQidhaAvailableContractStores({int? moduleId, String? type, String? search, int? offset, int? limit});
