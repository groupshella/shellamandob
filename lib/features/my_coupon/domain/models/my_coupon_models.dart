...
class CouponModel {
  ...
  CouponModel.fromJson(Map<String, dynamic> json) : isUsed = false {
    ...
    if (json['translations'] != null && json['translations'] is List) {
      ...
      for (final dynamic item in json['translations']) {
        if (item is Map<String, dynamic>) {
          translations!.add(Translation.fromJson(item));
        } else if (item is Map) {
          translations!.add(Translation.fromJson(Map<String, dynamic>.from(item)));
        }
      }
    }
  }
