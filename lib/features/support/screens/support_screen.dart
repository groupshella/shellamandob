...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Future<void> _openMap(String address, {String? lat, String? lng}) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SplashController>(builder: (splash) {
        ...
        final String? lat = config?.defaultLocation?.lat;
        final String? lng = config?.defaultLocation?.lng;
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _supportRow(
                        ...
                        title: 'address'.tr,
                        value: address,
                        onTap: () => _openMap(address, lat: lat, lng: lng),
                      ),
                      _supportRow(
                        image: Images.call,
