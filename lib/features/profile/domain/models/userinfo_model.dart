...
class UserInfoModel {
  ...
  // First Order Promotional Gift flags
  bool? hasClaimedFirstOrderGift;
  String? firstOrderClaimedAt;
  ...
  UserInfoModel({
    ...
    this.hasClaimedFirstOrderGift,
    this.firstOrderClaimedAt,
  });
  ...
  UserInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    // Promotional Gift flags
    hasClaimedFirstOrderGift = json.parseBool('has_claimed_first_order_gift');
    firstOrderClaimedAt = json.parseString('first_order_claimed_at');
  ...
  Map<String, dynamic> toJson() {
    ...
    // Promotional Gift flags
    data['has_claimed_first_order_gift'] = hasClaimedFirstOrderGift;
    data['first_order_claimed_at'] = firstOrderClaimedAt;
    return data;
  }
}
