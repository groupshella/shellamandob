...
class StatisticsScreenWithToggleState extends State<StatisticsScreenWithToggle>
        ...
        children: [
          ...
          PositionedDirectional(
            ...
            child: Row(
              children: [
                _qidhaMiniTile(
                    'st_total_balance'.tr, total, 'st_overall_balance'.tr),
  ...
  Widget _buildQidhaBalanceCard(String title, String value, dynamic icon,
          ...
          Row(
            children: [
              Container(
                ...
                child: icon is IconData ? Icon(icon, color: color, size: 18) : icon, // Reduced from 24
              ),
              const Spacer(),
              Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'متوسط ${(trend.averageOrderValue as num).toDouble().toStringAsFixed(2)} ريال',
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(
              fontFamily: 'Tajawal',
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: (() {
                        final icon = _getPaymentTypeIcon(payment['payment_type'] as String);
                        if (icon is IconData) {
                          return Icon(
                            icon,
  ...
  dynamic _getPaymentTypeIcon(String paymentType) {
    switch (paymentType) {
      case 'due_payment':
          ...
          child: Row(
            children: [
              Container(
                ...
                child:
                    const Icon(Icons.calendar_today, color: purple, size: 24),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 6),
              Text(
                '${totalDueAmount.toStringAsFixed(2)} ريال من أصل ${salaryAmount.toStringAsFixed(2)} ريال',
                textAlign: TextAlign.center,
                style: const TextStyle(
                  fontFamily: 'Tajawal',
                  fontSize: 14,
