...
class SimpleStatisticsScreen extends StatelessWidget {
  ...
  Widget _buildSummaryCard(
      String title, String value, dynamic icon, Color color) {
    return Container(
      width: 150,
      margin: const EdgeInsets.only(right: 8),
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          icon is IconData ? Icon(icon, color: color, size: 24) : icon,
  ...
  Widget _buildMostPurchasedProducts(AnalyticsController controller) {
    ...
    return Column(
      ...
      children: [
        ...
        ...controller.mostPurchasedProducts.take(5).map(
              (product) => Container(
  ...
  Widget _buildInsights(AnalyticsController controller) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        ...controller.insights!.insights.map(
          (insight) => Container(
            margin: const EdgeInsets.only(bottom: 8),
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color:
                    insight.severity == 'warning' ? Colors.orange : Colors.blue,
              ),
            ),
            child: Row(
              children: [
