...
extension _SearchScreenBuilders on SearchScreenState {
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (text) {
                            ...
                            if (text.isNotEmpty) {
                              ...
                              _actionSearch(
                                  searchController.isStore, text, false);
                            }
                          },
        ...
        if (searchController.isLoadingHistory) ...[
          ...
          for (int i = 0;
            ...
            _RecentSearchRow(
              ...
              onTap: () => _actionSearch(searchController.isStore,
                  searchController.historyList[i], false),
            ),
  ...
  Widget _MostSearchedSection(search.SearchController searchController) {
    ...
    final bool isFallbackStale = searchController.fallbackCategoriesModuleId !=
            null &&
        _selectedSearchModuleId != null &&
        searchController.fallbackCategoriesModuleId != _selectedSearchModuleId;
    if (isFallbackStale) {
      debugPrint(
    ...
    final bool hasFallbackData = !isFallbackStale &&
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            if (items.isNotEmpty &&
                                items.first.moduleType != null &&
                                items.first.moduleType!.isNotEmpty) ...[
                              ...
                              Container(
                                ...
                                child: Text(
                                  _getStoreTypeName(items.first.moduleType),
                                  style: TextStyle(
                                    fontSize: 10,
                                    fontWeight: FontWeight.w700,
                                    color: Theme.of(context).primaryColor,
  ...
  Widget _SearchResultItem({required dynamic item, required bool isStore}) {
    final bool isProductAvailable = isStore ||
        (item.stock == null || item.stock! > 0) &&
            DateConverter.isAvailable(
                item.availableTimeStarts, item.availableTimeEnds);
                      ...
                      Row(
                        children: [
                          ...
                          if (item.moduleType != null &&
                              item.moduleType!.isNotEmpty) ...[
                            const SizedBox(width: 6),
                            Text(
                              '(${_getStoreTypeName(item.moduleType)})',
                              style: TextStyle(
                                color: Theme.of(context).primaryColor,
                                fontSize: 11,
                                fontWeight: FontWeight.w600,
              ...
              if (!isStore) ...[
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.add,
                        size: 20, color: Color(0xFF31A342)),
                  ),
                ),
              ] else ...[
                const Icon(
