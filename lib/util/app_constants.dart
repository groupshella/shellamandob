...
class AppConstants {
  ...
  // âڑ، Feature Flag: BFF API v2 Unified Endpoint
  ...
  // â”€â”€ Native Apple Pay (PassKit) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // ── Standalone Marketer app ────────────────────────────────────────────────
  // Built with --dart-define=APP_MODE=marketer, the app boots straight into the
  // marketer ("مندوب تسويق قسائم شراء") service after the same login, instead of
  // the customer storefront. Because [isMarketerApp] is a compile-time const,
  // in the normal customer build every `if (isMarketerApp)` branch is
  ...
  // that MyFatoorah Apple Pay is active: the Apple Pay method (code 'ap') that
  // MyFatoorah returns is shown on iOS and pays through the existing
  // MFSDK.executePayment flow. Can still be forced off with
  // --dart-define=APPLE_PAY_NATIVE=false.
  static const bool applePayNativeEnabled =
      bool.fromEnvironment('APPLE_PAY_NATIVE', defaultValue: true);

  // â”€â”€ Embedded (in-app) card payment â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  static String get pusherHost => EnvironmentConfig.pusherHost;
  static String get pusherScheme => EnvironmentConfig.pusherScheme;
  static int get pusherPort => EnvironmentConfig.pusherPort;
  static String get pusherKey => EnvironmentConfig.pusherKey;
  ...
  static const String posCheckoutUri = '/api/v1/pos/checkout/';
  ...
  static const String storeContractRequestUri =
      '/api/v1/customer/store-contract-request';
  static const String getStoreContractRequestsUri =
      '/api/v1/customer/store-contract-requests';
  static const String qidhaContractedStoresUri =
      '/api/v1/customer/qidha/contracted-stores';
  static const String qidhaAvailableContractStoresUri =
      '/api/v1/customer/qidha/available-contract-stores';
  ...
  static const String submitStoreReviewUri = '/api/v1/stores/reviews/submit';
  ...
  static const String socialLoginUri = '/api/v1/auth/login';
  ...
  static const String supportSubmitUri = '/api/v1/customer/support/submit';
  ...
  static const String archiveConversationUri =
      '/api/v1/customer/message/archive';
  ...
  static const String chatSearchHistory = '6ammart_chat_search_history';
  ...
  static const String qrReferralInstallToken =
      '6ammart_qr_referral_install_token';
  ...
  // POS Customer Checkout Token Storage Key
  static const String pendingPosCheckoutToken = 'shella_pending_pos_checkout_token';
}
